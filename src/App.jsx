...
function App() {
  ...
  return (
    ...
    <Avatar name="anurag kash" size='70' text-color="purple" text-size="91" >
    some name
    </Avatar>

    
    <Avatar  src="https://i.pinimg.com/originals/81/13/79/811379a19dbc300e4ef19f851fd8ca05.gif" name="anurag kash" size='53' text-color="purple" text-size="4" >
    some name
    </Avatar>



    <p className="text-bold">abc</p>
    </>
  )
}
